...
- 📬 **微休息通知**：可开启在微休息开始和结束时发送系统通知，提供更直观的提醒
- 🖥️ **微休息全屏幕**：可开启强制全屏幕功能，在微休息时自动覆盖所有显示器画面，帮助用户完全脱离视觉干扰，休息结束后自动恢复
...
- 📊 **数据统计**：全新的专注数据统计功能，支持日/周/月/年多时间段查看，提供可视化图表展示专注次数和时长，包含总专注次数、总时长、平均时长、连续天数等详细统计信息，帮助用户更好地了解和改进专注习惯
